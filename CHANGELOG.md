...
### v1.7.1
- docs: **dashboard screenshot added to README** — closes #37. A real screenshot (not a mockup) of the `secureaudit serve` dashboard's run-detail view, generated by actually running a scan against a demo project with real planted findings and capturing the live server with Playwright.
